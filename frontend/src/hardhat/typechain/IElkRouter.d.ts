...
interface IElkRouterInterface extends ethers.utils.Interface {
  functions: {
...
export class IElkRouter extends Contract {
  ...
  interface: IElkRouterInterface;

  functions: {
    WAVAX(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
