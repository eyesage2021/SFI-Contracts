...
interface StakingRewardsSFITaxInterface extends ethers.utils.Interface {
  functions: {
...
export class StakingRewardsSFITax extends Contract {
  ...
  interface: StakingRewardsSFITaxInterface;
