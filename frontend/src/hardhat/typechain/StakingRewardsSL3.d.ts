...
interface StakingRewardsSL3Interface extends ethers.utils.Interface {
  functions: {
...
export class StakingRewardsSL3 extends Contract {
  ...
  interface: StakingRewardsSL3Interface;
