...
interface StakingRewardsShortInterface extends ethers.utils.Interface {
  functions: {
...
export class StakingRewardsShort extends Contract {
  ...
  interface: StakingRewardsShortInterface;
