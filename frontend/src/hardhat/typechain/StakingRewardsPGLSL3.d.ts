...
interface StakingRewardsPGLSL3Interface extends ethers.utils.Interface {
  functions: {
...
export class StakingRewardsPGLSL3 extends Contract {
  ...
  interface: StakingRewardsPGLSL3Interface;
