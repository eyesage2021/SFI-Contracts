...
interface StakingRewardsSFIWAVAXInterface extends ethers.utils.Interface {
  functions: {
...
export class StakingRewardsSFIWAVAX extends Contract {
  ...
  interface: StakingRewardsSFIWAVAXInterface;
