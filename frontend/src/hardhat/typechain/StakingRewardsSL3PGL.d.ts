...
interface StakingRewardsSL3PGLInterface extends ethers.utils.Interface {
  functions: {
...
export class StakingRewardsSL3PGL extends Contract {
  ...
  interface: StakingRewardsSL3PGLInterface;
