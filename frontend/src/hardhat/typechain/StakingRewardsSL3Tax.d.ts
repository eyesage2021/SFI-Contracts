...
interface StakingRewardsSL3TaxInterface extends ethers.utils.Interface {
  functions: {
...
export class StakingRewardsSL3Tax extends Contract {
  ...
  interface: StakingRewardsSL3TaxInterface;
