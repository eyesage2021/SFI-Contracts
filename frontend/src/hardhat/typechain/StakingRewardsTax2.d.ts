...
interface StakingRewardsTax2Interface extends ethers.utils.Interface {
  functions: {
...
export class StakingRewardsTax2 extends Contract {
  ...
  interface: StakingRewardsTax2Interface;
