...
interface StakingRewardsPGLSFIInterface extends ethers.utils.Interface {
  functions: {
...
export class StakingRewardsPGLSFI extends Contract {
  ...
  interface: StakingRewardsPGLSFIInterface;
