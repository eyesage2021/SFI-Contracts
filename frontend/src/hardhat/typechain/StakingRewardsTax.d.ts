...
interface StakingRewardsTaxInterface extends ethers.utils.Interface {
  functions: {
...
export class StakingRewardsTax extends Contract {
  ...
  interface: StakingRewardsTaxInterface;
