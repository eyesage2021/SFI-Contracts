...
interface StakingRewardsTax1Interface extends ethers.utils.Interface {
  functions: {
...
export class StakingRewardsTax1 extends Contract {
  ...
  interface: StakingRewardsTax1Interface;
