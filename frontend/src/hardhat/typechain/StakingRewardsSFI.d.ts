...
interface StakingRewardsSFIInterface extends ethers.utils.Interface {
  functions: {
...
export class StakingRewardsSFI extends Contract {
  ...
  interface: StakingRewardsSFIInterface;
